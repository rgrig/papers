...
\[
\set{Guard} =2^{ \set{Event}\times\set{Store}}
\]
...
\[
\mathit{Step}\in 2^{\set{World}\to\set{World}}
\]
\dinocomment{Rasmus can you check that the type above is right? Or should it be: 
$\mathit{Step}\in \set{World}\to 2^{\set{World}}$}
