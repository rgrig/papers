...
systems. The specifications are then used to instrument the byte-code  so that violations of the specification can be 
...
programmers have often  a global picture of the co-operation that the objects will have in different moment and the 
...
In contrast, TOPL intentionally avoid such decomposition.
...
Section~\ref{sec:syntax} gives the syntax of \TPL \ and  its semantics.
