...
The automaton is essentially depicted  in a graphical form, whereas  \autoref{fig:running.property} shows the same automaton given  as a list of labeled transitions. 
...
\grammar{
  ...
  ValuePattern& LowercaseId \| UppercaseId \| \b* \cr
  IntegerPattern& IntegerLiteral \| \b* \cr
}
