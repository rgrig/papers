...
It might look like some gratitious `name-dropping'.
...
\begin{align*}
&\text{\Verb@java.util.Collection.*[1]@} \\
&\text{\Verb@java.util.Iterator.*[1]@}
\end{align*}
...
\rg{A more realistic example that breaks this property?}
...
The paper~\cite{DeAlfaro-Henzinger} introduces an automata-based formalism for specifying properties of software interfaces. 
