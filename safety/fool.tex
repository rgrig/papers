...
This will require investigating suitable abstraction techniques to obtain meaningful and precise over-approximantions
of the state space of the programs. Moreover we intend to develop tailored bi-abduction inference technology~\cite{popl09} which would to help with scalability of the analysis.
%\rg{TODO: Static analysis.
%Two challenges: inference (biabduction), abstraction (garbage-collection like).}
