...
inorder to see if a transition is enabled, as many as the depth of the
guards.

Another consequence is, that the following events to be received are
...
\]
We now describe when transitions are enabled.
