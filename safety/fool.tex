...
the point of view of a single object. Conversely,  we take for typestate specification a similar position as Parkinson~\cite{parkinson-iwaco2007} for class invariant: we believe it is more intuitive and effective to specify a constraint of 
