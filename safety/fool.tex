...
\subsection{Iterators} \label{sec:examples.steps} % <<<
...
% >>>
\subsection{More Iterators} \label{sec:examples.others} % <<<
...
\rg{I'm inclined to remove this sub-section as it isn't very `temporal.'}
