...
\mathit{MethodPattern}$ be a TOPL label. If $\mathit{Context}$ is not
empty, it will be 
% >>>
...
% plan
% - all we need is traces
% - sool is an example of how traces are produced
% - here's an example sool program
% - here's the grammar; note
