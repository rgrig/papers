...
by the transitions: $V$ is the set of vertices mention as endpoints of
...
of the state space of the programs. Moreover we intend to develop tailored bi-abduction inference technology~\cite{DBLP:conf/popl/CalcagnoDOY09} which would help with scalability of the analysis.
