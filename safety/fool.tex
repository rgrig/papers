...
Therefore, although the program proceeds, the set of active states of the automaton remain unchanged.
...
\end{align}
If the transition is enabled and performed, the store for the vertex at the end of the arc will be $s_n$.
