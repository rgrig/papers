...
verification community~\cite{pnueli,spin,dblp:conf/cav/ballr01}. Safety properties are crucial for the correct behaviour of software and their  violation  may lead to unexpected run-time errors.
%
...
We will see later (\autoref{}) that TOPL is compiled into an intermediate language that can express such properties more succintly.
It is, however, unclear whether such properties are common, so we opted to 
