...
The repository includes several examples (such as the one in \autoref{sec:examples.steps}).
...
In this interpreter, we do keep track of sets of active states.
...
The high-level TOPL is designed to look like a normal object-oriented language.
...
It only handles a simple object-oriented language, but we are in the process of adapting the implementation to Java.
