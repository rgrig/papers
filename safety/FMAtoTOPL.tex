...
\dinocomment{Maybe explain the components of a register automaton} 
...
\dinocomment{we say, Arc includes.... but it's a bit informal. How about defining $\Arc= A_1 \cup A_2 \cup A_3 \cup A_4$ where $A_1$, $A_2$, $A_3$ and $A_4$ are defined with the definition of transitions above?}
