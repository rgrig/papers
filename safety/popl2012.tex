...
In the context of object-oriented programming  leading runtime verification techniques include JavaMOP~\cite{}, 
TraceMatches~\cite{}, and QVM~\cite{}, or techniques based on typestate~\cite{xxxxx}. Although powerful,  these methods present some limitations. For example in  
...
\dinocomment{it  can be shortened}
