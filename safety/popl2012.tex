...
(4)~The action of the last transition is superfluous, but required by the definition.%\hskip2mm plus 1fill
\vrule height1ex width1ex
\end{example}
...
For TOPL the control of the overhead is done manually by  the programmer who can tune the quantity of info to be tracked.
