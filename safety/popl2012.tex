...
\rg{I wouldn't say we `need' to remark this.
Still, $A$ is uncountable, so there is no finite representation for \emph{all} its members.
That's motivation to focus on a subset of $A$, which is what comes next.}}
