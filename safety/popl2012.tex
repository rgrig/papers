...
property:
\eqquote{Any value introduced by the {\tt input()} method should not reach the  {\tt sink()} method without passing first from the {\tt sanitizer()} method.}{q:concur-it3}
...
\eqquote{The shape of the list should not be neither circular nor pan-handle.}{q:concur-it3}
