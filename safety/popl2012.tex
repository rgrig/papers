...
\rg{Ideas for TOP-to-RA transformation:
Get rid of repeated values in registers.
For this, build an automaton with states $(q,P)$ where $P$ is a partition of the registers in the original.
}
