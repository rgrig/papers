...
each pattern $x$ which is not *, we define three functions $reg(x) : \N$,
...
\begin{array}{l l}
  l & \denG l \\
  \hline
  call\;m(x_1, \ldots, x_n) & \denG{m(x_1, \ldots, x_n)} \\
  ret\;x := m(x_1, \ldots, x_n) & {\sf eq}\,reg(x) = n+1 \land \denG{m(x_1, \ldots, x_n)} \\
\end{array}
\]
with $\denG{m(x_1, \ldots, x_n)} = pred(x_1)(2) \land\ldots\land pred(x_n)(n+1)$,
and $\denA-$ is given by
\[
\begin{array}{l l l}
  l & \denA l \\
  \hline
  call\;m(x_1, \ldots, x_n) & act(x_1)(2); \dots; act(x_n)(n+1) \\
  ret\;x := m(x_1, \ldots, x_n) & act(x_1)(2); \dots; act(x_n)(n); act(x)(n+2) \\
\end{array}
\]
