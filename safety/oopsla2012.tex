...
\grammar{
  ...
  Using& \b{using prefix} NamePattern \cr
...
%  StringPattern& \(Letter \| \b. \| \b*\)\+ \cr
  ...
  MethodPattern& (ValuePattern \b{:=} )\? NamePattern ArgumentsPattern \cr
%  ResultPattern& ValuePattern \b{:=} \cr
  NamePattern& \(Letter \| \b. \| \b*\)\+ \cr
  ArgumentsPattern& \b( \(ValuePattern \(\b, ValuePattern\)\*\)\? \b) \cr
  ArgumentsPattern& \b[ \b* \b] \|  \b[ IntegerLiteral \b] \cr
...
\begin{itemize}
%\item the data structures used to represent properties and a parser that instantiates them; 
...
To instrument the 160M of DACAPO sources and the JRE, it took  around 8 minutes.
...
\bibitem{DBLP:conf/oopsla/AllanACHKLMSST05}
...
\bibitem{ball2002}
T.~Ball and S.~K. Rajamani.
\newblock {\sc Slic}: a specification language for interface checking (of {C}).
...
\newblock {\em J. of Obj. Technology}, 3(6):27--56,~2004.

\bibitem{dblp:conf/sigsoft/BierhoffA05}
...
\bibitem{dblp:conf/sigsoft/boddenlh08}
...
\bibitem{dblp:conf/popl/CalcagnoDOY09}
...
\bibitem{DBLP:conf/oopsla/DistefanoP08}
...
\bibitem{dblp:journals/scp/FieldGRY05}
J.~Field, D.~Goyal, G.~Ramalingam, E.~Yahav.
\newblock Typestate verification: Abstraction techniques and complexity
  results.
\newblock {\em Sci. Comput. Program.}, 58(1-2):57--82,~2005.

\bibitem{dblp:conf/issta/FinkYDRG06}
...
%\bibitem{dblp:conf/oopsla/2008}
%Gail~E. Harris, editor.
%\newblock {\em Proceedings of the 23rd Annual ACM SIGPLAN Conference on
%  Object-Oriented Programming, Systems, Languages, and Applications, OOPSLA
%  2008, October 19-23, 2008, Nashville, TN, USA}. ACM, 2008.

\bibitem{dblp:conf/oopsla/naeeml08}
...
\newblock Typestate: A programming language concept for enhancing software
  reliability.
\newblock {\em IEEE Trans. Software Eng.}, 12(1):157--171, 1986.
