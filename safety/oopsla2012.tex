...
\multirow{2}{*}{pmd}
  ...
  & \multicolumn{4}{c}{\multirow{2}{*}{time $>100\times5.2\rm\,s$}}\\
  &&
  & \multicolumn{2}{c}{$\sim24\rm\,MiB$}
  & \multicolumn{2}{c}{$\sim22\rm\,MiB$}
  & \multicolumn{2}{c}{$\sim22\rm\,MiB$}
  \\[1ex]
\multirow{2}{*}{h2}
  & $6.6\rm\,s$ & $\pm0.2\rm\,s$
  ...
  & \multicolumn{6}{c}{\multirow{2}{*}{time $>100\times6.6\rm\,s$}} \\
  &&
  & \multicolumn{2}{c}{$\sim210\rm\,MiB$}
  & \multicolumn{2}{c}{$\sim209\rm\,MiB$}
  \\
\end{tabular}
\caption{
...
\input{FMAtoTOPL}
% >>>
\section{Implementation} \label{sec:dynamic} % <<<
