...
If $r_0(I_g)=\emptyset$, then $(q_{j-1},r_{j-1})$ has $|[2m]-I'|+1$ successors with the guards {\sf fresh} and, respectively, ${\sf eq}\,i$ for $i\in[2m]-I'$.
...
First a target is picked, and then the saving of component~$j$ in registers~$I_a$ is simulated.
