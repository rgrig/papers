...
To show that $L_5$ is not definable by TOPL automata

\rg{TODO: TOPL languages are closed under prefix, because emptiness is decidable.
Thus, $L_5$ not definable implies $L_4$ not definable.}
