...
\autoref{sec:topl_automata} introduces another instance of $t$-automata, namely TOPL automata.
Each TOPL automaton has an equivalent register automaton, which may be very complicated.


\rg{TODO: Talk about extended $t$-automata, and prove they are equivalent to $t$-automata.}
...
This generalized model, history TOPL automata, have a special kind of register that holds sets of values, rather than values.
