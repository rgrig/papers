...
\rlp{Describe g'_{d'-1} and a'_{d'-1}.}
...
\smallskip
Finally, we add one final state, and transitions to it from the states $(q_\rho, h, k, r)$ where $q_r_rho$ is final in ${\cal A}_\rho$ and $h=0$.
