...
This is also the point of view taken by tracematches~\cite{DBLP:conf/oopsla/AllanACHKLMSST05}, however, TOPL is more expressive than tracematches as it allow, for example to encode properties involving overwrite of values or shapes of dynamic allocated data strucutres (e.g., cyclic vs acyclic linked list, etc).
...
\end{Verbatim}    
\caption{The property {\tt InvalidateOtherIterators} in diagram (up) and textual form (down).
}
