...
state.  The command \shell{fb -dis=log examples/simples.bpl} generates a
...
the Boogie AST\null. FreeBoogie does \emph{not} keep the derived
information in sync with the AST, but re-derives it after each modification
of the AST\null.
