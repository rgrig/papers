...
% @review JRK A prelude to this run example is missing.
...
% @review JRK *not really* (Perhaps put these subsections in an
% appendix in a tech report version of the paper that we can cite?)
...
\label{sec:design.ds}
% @review JRK *maybe* (the beginning is nice, but then it gets a bit
% overly pendantic/detailed for this kind of paper)
...
\subsection{Provers}
% @review JRK *maybe* (but significantly shrunk)
