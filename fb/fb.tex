...
\usepackage{listings}
\usepackage{mathrsfs}  % TODO: perhaps get rid of these funky letters
...
% {{{ abstract
\begin{abstract}
FreeBoogie is a verification condition generator.

This chapter is rather dense. A cursory read will show
how the later, more theoretical chapters fit together in the
context of a real program; a careful read will serve as a guide
to FreeBoogie's source code for new developers.
\end{abstract}
% }}} abstract
%{{{ run
